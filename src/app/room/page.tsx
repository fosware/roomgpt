        ...
        <div className='w-full flex flex-col md:flex-row items-center md:items-stretch gap-20 px-10'>
            ...
            <div className='md:w-2/3 flex flex-col items-center pb-10'>
               <div className='md:flex hidden flex-col gap-5 text-center'>
                    <h1 className='text-6xl text-white font-bold'>Redesign your <span className='text-blue-500'>room</span> in seconds</h1>
                    <p className='text-2xl text-white'>Upload a room, specify the room type, and select your room theme to redesign.</p>
               </div>
               {/* Preview componen */}
            </div>
        </div>
